...
public class AltaPostulanteConocimiento extends javax.swing.JFrame {
    ...
    public AltaPostulanteConocimiento(SistemaTemporal sistema, Postulante postulante) {
    ...
    public void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AltaPostulanteConocimiento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AltaPostulanteConocimiento(miSistema, postulante).setVisible(true);
            }
        });
    }
