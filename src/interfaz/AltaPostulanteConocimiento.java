...
//          jComboBoxConocimientos.addItem(item);
//        }
    ArrayList<Habilidad> habilidades = Habilidad.obtenerListaHabilidades();
    for(Habilidad habilidad : habilidades) {
        jComboBoxHablidades.addItem(habilidad.toString());
    }
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Habilidad habilidad = (Habilidad)jComboBoxHablidades.getSelectedItem();
        postulante.addHabilidad(habilidad, (Integer)jSpinnerNivel.getValue());
//        jListHabilidades.add
